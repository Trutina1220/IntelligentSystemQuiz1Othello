...
public class OthelloMinimax extends OthelloPlayer
{
    ...
    public OthelloMinimax(boolean isMax, int depth)
    {
        this(isMax, depth, new OthelloScorerC());
    }

    public OthelloMinimax(boolean isMax, int depth, OthelloScorer scorer)
    {
        isMax_ = isMax;
        depth_ = depth;
        scorer_ = scorer;
    ...
    public OthelloMove getMove(OthelloGame state)
    {
    ...
    private int minimax(OthelloGame state, boolean maxPlayer, int depth)
    {
