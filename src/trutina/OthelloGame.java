...
public class OthelloGame {
    ...
    public OthelloGame clone() {
        OthelloGame newState = new OthelloGame();
        for(int i = 0;i<boardSize;i++)
            for(int j = 0;j<boardSize;j++)
    ...
    public List<OthelloMove> generateMoves(int player) {
        List<OthelloMove> moves = new /*ArrayList<OthelloMove>();//*/LinkedList<OthelloMove>();
     ...
     */
    public OthelloGame applyMoveCloning(OthelloMove move) {
        OthelloGame newState = clone();
